...
export default function NavigationBar(){
    return (
        <header className="flex flex-row justify-center items-center p-5 gap-11 absolute top-0 left-0 right-0 z-50 text-oldlace">
            <nav className="flex gap-6">
                <Link href="/" className="shadow-text rounded-full border border-transparent hover:border-white px-3 transition-all ease-in-out duration-300 active-home">HOME</Link>
